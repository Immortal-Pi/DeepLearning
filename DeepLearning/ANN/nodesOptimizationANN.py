...
model = Sequential([
            ...
            keras.layers.Dense(hidden_layer_size, activation='relu',kernel_constraint=keras.constraints.maxnorm(3)),
...
cb = keras.callbacks.TensorBoard(log_dir='nodes_optimization', write_graph=False)
print('Building model initializer')
