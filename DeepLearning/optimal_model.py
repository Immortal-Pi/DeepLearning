...
model=Sequential([
    ...
    keras.layers.Dense(units=hidden_unit_size,activation='relu',kernel_initializer=tf.initializers.HeNormal(),bias_initializer=tf.initializers.constant(value=0.01),kernel_regularizer=keras.regularizers.l2()),
